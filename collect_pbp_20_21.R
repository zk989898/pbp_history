...
### GET PBPs ###
schedule_20_21 <- league_schedule("2021-01-09","2021-05-20")
pbp <- game_scraper_html(2020020001)
completed_games <- schedule_20_21 %>% filter(home_score+away_score>0)
...
missing_20_21 <- length(setdiff(completed_games$game_id,unique(pbp$game_id)))
pbp %>% saveRDS("data/pbp_20_21.rds")
rm(schedule_20_21,pbp,completed_games,games_to_scrape)
print(missing_20_21)
