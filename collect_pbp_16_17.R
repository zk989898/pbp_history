...
### GET PBPs ###
schedule_16_17 <- league_schedule("2016-10-10","2017-04-11")
pbp <- game_scraper_html(2016020001)
completed_games <- schedule_16_17 %>% filter(home_score+away_score>0)
...
missing_16_17 <- length(setdiff(completed_games$game_id,unique(pbp$game_id)))
pbp %>% saveRDS("data/pbp_16_17.rds")
rm(schedule_16_17,pbp,completed_games,games_to_scrape)
print(missing_16_17)
