...
### GET PBPs ###
schedule_23_24 <- league_schedule("2023-10-07","2024-04-17")
pbp <- game_scraper_html(2023020001)
completed_games <- schedule_23_24 %>% filter(home_score+away_score>0)
...
missing_23_24 <- setdiff(completed_games$game_id,unique(pbp$game_id))
pbp %>% saveRDS("data/pbp_23_24.rds")
rm(schedule_23_24,pbp,completed_games,games_to_scrape)
print(missing_23_24)
