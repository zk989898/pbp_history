...
### GET PBPs ###
schedule_17_18 <- league_schedule("2017-10-02","2018-04-10")
pbp <- game_scraper_html(2017020001)
completed_games <- schedule_17_18 %>% filter(home_score+away_score>0)
...
missing_17_18 <- length(setdiff(completed_games$game_id,unique(pbp$game_id)))
pbp %>% saveRDS("data/pbp_17_18.rds")
rm(schedule_17_18,pbp,completed_games,games_to_scrape)
print(missing_17_18)
