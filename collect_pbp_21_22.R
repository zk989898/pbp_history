...
### GET PBPs ###
schedule_21_22 <- league_schedule("2021-10-05","2022-05-02")
pbp <- game_scraper_html(2021020001)
completed_games <- schedule_21_22 %>% filter(home_score+away_score>0)
...
missing_21_22 <- length(setdiff(completed_games$game_id,unique(pbp$game_id)))
pbp %>% saveRDS("data/pbp_21_22.rds")
rm(schedule_21_22,pbp,completed_games,games_to_scrape)
print(missing_21_22)
