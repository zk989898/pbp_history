...
### GET PBPs ###
schedule_18_19 <- league_schedule("2018-10-01","2019-04-08")
pbp <- game_scraper_html(2018020001)
completed_games <- schedule_18_19 %>% filter(home_score+away_score>0)
...
missing_18_19 <- length(setdiff(completed_games$game_id,unique(pbp$game_id)))
pbp %>% saveRDS("data/pbp_18_19.rds")
rm(schedule_18_19,pbp,completed_games,games_to_scrape)
print(missing_18_19)
