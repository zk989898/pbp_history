...
### GET PBPs ###
schedule_09_10 <- league_schedule("2009-09-30","2010-04-13")
pbp <- game_scraper_html(2009020001)
completed_games <- schedule_09_10 %>% filter(home_score+away_score>0)
...
missing_09_10 <- length(setdiff(completed_games$game_id,unique(pbp$game_id)))
pbp %>% saveRDS("data/pbp_09_10.rds")
rm(schedule_09_10,pbp,completed_games,games_to_scrape)
print(missing_09_10)
