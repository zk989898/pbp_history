...
### GET PBPs ###
schedule_19_20 <- league_schedule("2019-10-01","2020-03-14")
pbp <- game_scraper_html(2019020001)
completed_games <- schedule_19_20 %>% filter(home_score+away_score>0)
...
missing_19_20 <- length(setdiff(completed_games$game_id,unique(pbp$game_id)))
pbp %>% saveRDS("data/pbp_19_20.rds")
rm(schedule_19_20,pbp,completed_games,games_to_scrape)
print(missing_19_20)
