...
### GET PBPs ###
schedule_12_13 <- league_schedule("2013-01-17","2013-04-30")
pbp <- game_scraper_html(2012020001)
completed_games <- schedule_12_13 %>% filter(home_score+away_score>0)
...
missing_12_13 <- length(setdiff(completed_games$game_id,unique(pbp$game_id)))
pbp %>% saveRDS("data/pbp_12_13.rds")
rm(schedule_12_13,pbp,completed_games,games_to_scrape)
print(missing_12_13)
