...
### GET PBPs ###
schedule_14_15 <- league_schedule("2014-10-06","2015-04-13")
pbp <- game_scraper_html(2014020001)
completed_games <- schedule_14_15 %>% filter(home_score+away_score>0)
...
missing_14_15 <- length(setdiff(completed_games$game_id,unique(pbp$game_id)))
pbp %>% saveRDS("data/pbp_14_15.rds")
rm(schedule_14_15,pbp,completed_games,games_to_scrape)
print(missing_14_15)
