...
### GET PBPs ###
schedule_10_11 <- league_schedule("2010-10-05","2011-04-12")
pbp <- game_scraper_html(2010020001)
completed_games <- schedule_10_11 %>% filter(home_score+away_score>0)
...
missing_10_11 <- length(setdiff(completed_games$game_id,unique(pbp$game_id)))
pbp %>% saveRDS("data/pbp_10_11.rds")
rm(schedule_10_11,pbp,completed_games,games_to_scrape)
print(missing_10_11)
