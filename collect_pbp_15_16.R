...
### GET PBPs ###
schedule_15_16 <- league_schedule("2015-10-05","2016-04-12")
pbp <- game_scraper_html(2015020001)
completed_games <- schedule_15_16 %>% filter(home_score+away_score>0)
...
missing_15_16 <- length(setdiff(completed_games$game_id,unique(pbp$game_id)))
pbp %>% saveRDS("data/pbp_15_16.rds")
rm(schedule_15_16,pbp,completed_games,games_to_scrape)
print(missing_15_16)
