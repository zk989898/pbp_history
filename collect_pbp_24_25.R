...
### GET PBPs ###
schedule_24_25 <- league_schedule("2024-10-03","2025-04-19")
pbp <- game_scraper_html(2024020001)
...
missing_24_25 <- setdiff(completed_games$game_id,unique(pbp$game_id))
pbp %>% saveRDS("data/pbp_24_25.rds")
rm(schedule_24_25,pbp,completed_games,games_to_scrape)
print(missing_24_25)
