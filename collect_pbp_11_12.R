...
### GET PBPs ###
schedule_11_12 <- league_schedule("2011-10-04","2012-04-08")
pbp <- game_scraper_html(2011020001)
completed_games <- schedule_11_12 %>% filter(home_score+away_score>0)
...
missing_11_12 <- length(setdiff(completed_games$game_id,unique(pbp$game_id)))
pbp %>% saveRDS("data/pbp_11_12.rds")
rm(schedule_11_12,pbp,completed_games,games_to_scrape)
print(missing_11_12)
